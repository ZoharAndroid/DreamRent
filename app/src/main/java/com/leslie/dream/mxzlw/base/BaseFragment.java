...
public abstract class BaseFragment extends Fragment
        implements OnClickListener, IRefreshTopMoreListener, BaseAdapter.OnItemClickListener {
    ...
    protected void initLoadView() {
        loadview_ll = fv(R.id.loadview_ll, main_layout);
        loadview_pb = fv(R.id.loadview_pb, main_layout);
        loadview_tv = fv(R.id.loadview_tv, main_layout);
    }
