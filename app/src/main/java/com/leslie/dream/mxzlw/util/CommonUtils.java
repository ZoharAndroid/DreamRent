...
public class CommonUtils {
     ...
     * 从url中读取参数值
     * */
    public static Map getKeyByUrl(String url){
        Map<String, String> map = new HashMap<String, String>();
        String[] param = url.split("\\?");
        //a=1&b=2&c=3
        String[] item = param[1].split("&");
        //a=1 b=2 c=3
        int len = item.length;
        for(int i=0;i<len;i++){
    ...
    public static boolean isEmpty(Object list) {
        ...
        }/* else if (list instanceof Objects[]) {
            return ((Objects[]) list).length == 0;
    ...
    public static boolean cache(Context context, Object... obj) {
        return SharePreferenceUtil.cache(context, obj);
    }
