...
import com.leslie.dream.mxzlw.widget.v7.FooterStatusView;
import com.leslie.dream.mxzlw.widget.v7.RecyclerViewWrap;


/**
 * @Author dzl on 2017/7/6.
 */
public class BaseRecyclerViewActivity extends BaseActionbarActivity
    ...
    protected int footer_params_width = 0; // footer底部宽度
    protected int footer_params_height = 0; // footer底部高度
    ...
    public void onFooterEmptyClick(View v) {
        // reqData(URL_LIST, LOAD_TOP); // 空 数据
    }
    ...
    public void onFooterErrorClick(View v) {
        // presenter.reqDataReTry(); //加载错误时，重新加载
    }
}
