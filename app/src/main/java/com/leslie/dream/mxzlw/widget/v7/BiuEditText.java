...
//        setlistener();
    ...
    private void update(char last, boolean isUp, int i) {
        ...
        float endY = 0;
        if (isUp) {
//            startX = location[0]+layout.getPrimaryHorizontal(pos) + 80;
            startX = location[0] + layout.getPrimaryHorizontal(pos - i + 1);
            startY = height / 3 * 2 + 50;
            endX = startX;
//            endY = baseline + ascent;
            ...
            endY = height / 3 * 2;
//            startX = location[0]+layout.getPrimaryHorizontal(pos) + 70;
            startX = location[0] + layout.getPrimaryHorizontal(pos);
            startY = location[1];
        }
